...
$user_products_query = "select *  from cart  where user='$useremail'";
    ...
    <div class="container">
      <table class="table table-bordered table-striped">
        <form method="post">
          <tbody>
            <tr>
              <th>Select items to purchase</th>
              <th>Item Number</th>
              <th>Item Name</th>
              <th>Price</th>
              <th>Want to remove item</th>
            </tr>
            <?php
            $user_products_result = mysqli_query($con, $user_products_query) or die(mysqli_error($con));
            $no_of_user_products = mysqli_num_rows($user_products_result);
            ...
            while ($row = mysqli_fetch_array($user_products_result)) {
              ...
              $ex = mysqli_query($con, "Select * from products where id='$product_id' ") or die(mysqli_error($con));
              if (mysqli_num_rows($ex) > 0) {
                while ($row = mysqli_fetch_array($ex)) {
                  ?>
                  <tr>
                    <th><input type="checkbox" name="productid[]" value="<?php echo $row['id'] ?>"></th>
                    <th>
                      <?php echo $counter ?>
                    </th>
                    <th>
            ...
            <div class="col-md-7 col-lg-8">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="input-group has-validation">
                    <input type="text" class="form-control" id="username" name="username"
                      value="<?php echo $_SESSION['email']; ?>" placeholder="Username" readonly>
              ...
              <div class="my-3">
                <div class="form-check">
                  <input id="credit" name="payment_method" type="radio" class="form-check-input" required>
                  <label class="form-check-label" name="credit" for="credit">Pay pal</label>
                </div>
                <div class="form-check">
              ...
              <div class="row gy-3">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="cc_number" name="cc_number" minlength="12" maxlength="12" placeholder="" required>
                  <div class="invalid-feedback">
                ...
                <div class="col-md-3">
                  ...
                  <input type="text" id="cc_expiration" name="cc_expiration" pattern="(0[1-9]|1[0-2])\/[0-9]{2}" placeholder="MM/YY" required>
                ...
                <div class="col-md-3">
                  ...
                  <input type="text" class="form-control" id="cc_cvv" name="cc_cvv" minlength="3" maxlength="3" placeholder="" required>
                  <div class="invalid-feedback">
